...
public class PdfUtils {
	...
	public static final String COMP_NAME = "Dehu Road Cantonment Baord";
	public static final String ADD_LINE1 = "Near Railway Station,";
	public static final String ADD_LINE2 = "Pune, Maharashtra - 412101.";
